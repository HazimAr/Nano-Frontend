...
export default function Games({ session, data, guild_id, cookies }: { session: DiscordUser; data: any; guild_id: string; cookies: any }): JSX.Element {
	const { commands } = data;
	return (
...
export async function getServerSideProps(context: any) {
	...
	const data = await defaultPostRequest('g/groups/games', guild_id, session.accessToken);
