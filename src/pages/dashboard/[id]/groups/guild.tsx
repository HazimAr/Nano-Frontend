...
export default function Guild({ session, data, guild_id, cookies }: { session: DiscordUser; data: any; guild_id: string; cookies: any }): JSX.Element {
	const { commands } = data;
	return (
...
export async function getServerSideProps(context: any) {
	...
	const data = await defaultPostRequest('g/groups/guild', guild_id, session.accessToken);
