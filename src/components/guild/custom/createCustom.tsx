...
import { Box, Heading, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Stack, Textarea, useDisclosure, useToast } from '@chakra-ui/react';
						...
						<ModalBody>
							<Stack>
								...
								<Input
									...
									onChange={(e: any) => {
										const command = e.target.value.substring(1).trim();
								...
								<Textarea
									...
									onChange={(e: any) => {
										...
										if (response.length > 2000) {
											setResponse(response.substring(0, 2000));
											return;
										}
						...
						<ModalFooter>
							...
							<Button
								onClick={async () => {
									...
									toast({
										title: 'Sent',
										description: 'Your custom command is being created',
									...
									if (!data) {
										toast({
											title: 'Error',
											description: 'There was an error with creating your command. If this persists to happen, please contact one of the developers',
											status: 'error',
											duration: 3000,
											isClosable: true,
										});
